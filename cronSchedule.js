...
function scheduleStart(slackSend){
    var startLessonOnAm = new CronJob("0 30 10-11 * * 1-5",function(){slackSend("<!channel> 授業開始だよ!")},null,true,"Asia/Tokyo")
    var startLessonOnPm = new CronJob("0 30 13-16 * * 1-5",function(){slackSend("<!channel> 授業開始だよ!")},null,true,"Asia/Tokyo")
